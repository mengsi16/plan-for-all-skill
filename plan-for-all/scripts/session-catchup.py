#!/usr/bin/env python3
"""
Session Catchup Script for step-planning
...
PLANNING_FILES = [
    ...
    'progress.md',
    'findings.md',
    'docs/superpowers/plans/step_subplans/step_subplan_phase1.md',
    'docs/superpowers/plans/step_subplans/step_subplan_phase2.md'
]
...
def get_project_dir(project_path: str) -> Tuple[Optional[Path], Optional[str]]:
    ...
    if is_codex_variant and codex_sessions_dir.exists() and not claude_path.exists():
        return None, (
            "[step-planning] Session catchup skipped: Codex stores sessions "
...
def main():
    ...
    print("\n[step-planning] SESSION CATCHUP DETECTED")
    ...
    print("3. Check current in_progress step in task_plan.md")
    print("4. Read corresponding step_subplan_*.md if exists")
